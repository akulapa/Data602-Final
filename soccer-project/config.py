...
MODELPICKLE = os.path.join(basedir, 'app/instance/model.pickle')
FEATURESPICKLE = os.path.join(basedir, 'app/instance/features.pickle')
MATCHESCSV = os.path.join(basedir, 'app/instance/temp/matchDf.csv')
