...
from config import MATCHESCSV, MODELPICKLE
import pickle

def generate_modelpickle():
    # --------------------------------------------------------------------
    # IMPORT DATA
    # --------------------------------------------------------------------
    ...
    matchDf = pd.read_csv(MATCHESCSV)
    ...
    with open(MODELPICKLE, 'wb') as handle:
        pickle.dump(clf, handle, protocol=pickle.HIGHEST_PROTOCOL)
    
    # Test
    with open(MODELPICKLE, 'rb') as handle:
